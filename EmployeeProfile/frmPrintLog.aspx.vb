...
Partial Class EmployeeProfile_frmPrintLog
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            GetPrintog(ToWhomProShow)
        End If
    End Sub

    Protected Sub GetPrintog(ByVal EmployeeID As String)
        Try
            grdPrintActivity.DataSource = EmployeeData.fnGetPrintActivityByUser(EmployeeID)
            grdPrintActivity.DataBind()
