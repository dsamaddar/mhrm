...
Partial Class EmployeeProfile_frmAssetList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            GetAssetList(ToWhomProShow)
        End If
    End Sub

    Protected Sub GetAssetList(ByVal UserID As String)
        Try
            grdAssetList.DataSource = EmployeeData.fnGetAssetList(UserID)
