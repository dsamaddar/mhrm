...
Partial Class EmployeeProfile_frmEmpAttendanceStatusByYear
    ...
    Protected Sub btnProcessReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcessReport.Click
        Try
            grdEmpAttendanceReport.DataSource = UsrAttData.fnReporYearlyAttStatus(Session("ToWhomProShow"), drpReportYear.SelectedValue, drpAttStatus.SelectedValue)
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            drpAttStatus.SelectedValue = "Absent"
