...
Partial Class frmRetrieveZKAttendanceLog
    ...
    Protected Sub GetAttendanceLog()
        Try
            grdAttendanceLog.DataSource = UsrAttData.fnGetZKAttLog()
        ...
        Try
            For Each row As GridViewRow In grdAttendanceLog.Rows
                ...
                If chkItems.Checked = True Then
                    ...
                    Dim check As Integer = UsrAttData.fnInsertZKUserAttendance(UsrAtt)
