...
Create proc spMergeFileStorageDeptWithHRM
as
begin
-- Create a temporary table variable to hold the output actions.
DECLARE @SummaryOfChanges TABLE(Change VARCHAR(20));

MERGE INTO FileManager.dbo.tblDepartment AS Target
...
-- exec spMergeFileStorageDeptWithHRM

GO

Create proc spMergeFileStorageBranchWithHRM
as
begin
...
MERGE INTO FileManager.dbo.tblULCBranch AS Target
...
--exec spMergeFileStorageBranchWithHRM

GO


Create proc spMergeFileStorageDesignationWithHRM
as
begin
-- Create a temporary table variable to hold the output actions.
DECLARE @SummaryOfChanges TABLE(Change VARCHAR(20));

MERGE INTO FileManager.dbo.tblDesignation AS Target
...
-- exec spMergeFileStorageDesignationWithHRM

GO

Create proc spMergeFileManagerEmpListWithHRM
as
begin
...
MERGE INTO FileManager.dbo.tblEmployeeInfo AS Target
...
-- exec spMergeFileManagerEmpListWithHRM