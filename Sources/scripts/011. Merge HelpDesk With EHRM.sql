...
Create proc spMergeHelpDeskDesignationWithHRM
as
begin
-- Create a temporary table variable to hold the output actions.
DECLARE @SummaryOfChanges TABLE(Change VARCHAR(20));

MERGE INTO HelpDesk.dbo.tblDesignation AS Target
...
Create proc spMergeHelpDeskDeptWithHRM
as
begin
-- Create a temporary table variable to hold the output actions.
DECLARE @SummaryOfChanges TABLE(Change VARCHAR(20));

MERGE INTO HelpDesk.dbo.tblDepartment AS Target
...
Create proc spMergeHelpDeskBranchWithHRM
as
begin
...
MERGE INTO HelpDesk.dbo.tblULCBranch AS Target
...
Create proc spMergeHelpDeskEmpListWithHRM
as
begin
...
MERGE INTO HelpDesk.dbo.tblEmployeeInfo AS Target
...
-- exec spMergeHelpDeskDesignationWithHRM
-- exec spMergeHelpDeskDeptWithHRM
-- exec spMergeHelpDeskBranchWithHRM
-- exec spMergeHelpDeskEmpListWithHRM