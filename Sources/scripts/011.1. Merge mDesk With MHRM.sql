...
alter proc spMergemDeskDesignationWithHRM
as
begin
-- Create a temporary table variable to hold the output actions.
DECLARE @SummaryOfChanges TABLE(Change VARCHAR(20));

MERGE INTO mDesk.dbo.tblDesignation AS Target
USING MHRM.dbo.tblDesignation As Source
...
alter proc spMergemDeskDeptWithHRM
as
begin
-- Create a temporary table variable to hold the output actions.
DECLARE @SummaryOfChanges TABLE(Change VARCHAR(20));

MERGE INTO mDesk.dbo.tblDepartment AS Target
USING MHRM.dbo.tblDepartment As Source
...
alter proc spMergemDeskBranchWithHRM
as
begin
...
MERGE INTO mDesk.dbo.tblULCBranch AS Target
USING MHRM.dbo.tblULCBranch As Source
...
alter proc spMergemDeskEmpListWithHRM
as
begin
...
MERGE INTO mDesk.dbo.tblEmployeeInfo AS Target
USING MHRM.dbo.tblEmployeeInfo As Source
